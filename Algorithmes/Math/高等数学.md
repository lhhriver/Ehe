...
1. 切线方程 : $y-{{y}_{0}}=f'({{x}_{0}})(x-{{x}_{0}})$

2. 法线方程：$y-{{y}_{0}}=-\frac{1}{f'({{x}_{0}})}(x-{{x}_{0}}),f'({{x}_{0}})\ne 0$
...
|             $y={{a}^{x}}$             | ${y}'={{a}^{x}}\ln a$                            | $dy={{a}^{x}}\ln adx$                                  |
|             $y={{e}^{x}}$             | ${y}'={{e}^{x}}$                                 | $dy={{e}^{x}}dx$                                       |
|          $y={{\log }_{a}}x$           | ${y}'=\frac{1}{x\ln a}$                          | $dy=\frac{1}{x\ln a}dx$                                |
|               $y=\ln x$               | ${y}'=\frac{1}{x}$                               | $dy=\frac{1}{x}dx$                                     |
...
- 函数$f(x)$在${{x}_{0}}$的某邻域内有定义，并且在此邻域内恒有$f(x)\le f({{x}_{0}})$或$f(x)\ge f({{x}_{0}})$,
