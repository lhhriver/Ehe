...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-161252-1703351200807-3438.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-176252.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-191251.png)

在程序控制窗口，共有 6 个按钮，他们的作用分别又是什么呢？同时看下面这张图就行了。

![](./images/N09-调试技巧/Python中文指南-20211128-171029-206255.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171030-135252.png)

进入设置面板，在 `Script parameters` 中填入参数即可。

![](./images/N09-调试技巧/Python中文指南-20211128-171030-197258.png)

同时在上图的底部，你可以看到，这里可以很方便的切换 解释器，比你跑到这边来要容易得多吧

![](./images/N09-调试技巧/Python中文指南-20211128-171030-165250.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171030-045251.png)

就进入了 `Python Shell` 的界面，这个Shell 环境和我们当前运行的程序环境是打通的，变量之间可以互相访问，这下你可以轻松地进行调试了。

![](./images/N09-调试技巧/Python中文指南-20211128-171030-076255.png)

上面我们打了个断点，是为了方便说明这个效果。并不是说一定要打断点。如果不打断点，在脚本执行完成后，也仍然可以在这个界面查看并操作所有变量。

![](./images/N09-调试技巧/Python中文指南-20211128-171030-121260.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171030-061251.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171030-181250.png)

就弹出了一个 `Evaluate Expression` 窗口，这里 可以运行命令表达式，直接操作变量。

![](./images/N09-调试技巧/Python中文指南-20211128-171030-152257.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-100251.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-118255.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-651251.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-666254.png)

![](./images/N09-调试技巧/Python中文指南-20211128-171028-681252.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-712259.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-696256.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-402253.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-416253.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-432256.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-446264.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-381251.png)

##  配置连接服务器

Tools -> Deployment -> configuration

![](./images/N09-调试技巧/Python中文指南-20211128-171028-398255.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-411251.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-426253.png)

填写完成后，切换到`Mappings`选项卡，在箭头位置，填写`\`

![](./images/N09-调试技巧/Python中文指南-20211128-171028-441254.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-456252.png)

##  下载项目代码

如果之前填写的服务器登陆信息准确无误的话，现在就可以看到远程的项目代码。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-471257.png)

选择下载远程代码要本地。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-486253.png)

下载完成提示。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-501255.png)

现在的IDE界面应该是这样子的。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-516260.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-531252.png)

填写远程服务器信息，跟之前的一样，不再赘述。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-549253.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-561255.png)

##  调试前设置

开启代码自动同步，这样，我们对代码的修改Pycharm都能识别，并且为我们提交到远程服务器。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-576252.png)

开启 `Gevent compatible`，如果不开启，在调试过程中，很可能出现无法调试，或者无法追踪/查看变量等问题。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-621252.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171028-591253.png)

配置完点击保存即可。

![](./images/N09-调试技巧/Python中文指南-20211128-171028-607254.png)
...
![](./images/N09-调试技巧/Python中文指南-20211128-171029-792252.png)

如果你不是想等报错了再调试，而是一开始就想进入调试模式，可以使用 `pdb.runcall()` 函数

![](./images/N09-调试技巧/Python中文指南-20211128-171029-806254.png)
