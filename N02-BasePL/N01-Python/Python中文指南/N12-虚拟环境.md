...
![](./images/N12-虚拟环境/Python中文指南-20211128-171029-055251-1703351171916-3368.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171029-927257.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171029-941254.png)

###  PyCharm中

点击 File - Settings - Project - Interpreter

![](./images/N12-虚拟环境/Python中文指南-20211128-171029-956264.png)
点击小齿轮。如图点击添加，按提示添加一个虚拟环境。然后点 OK 就可以使用这个虚拟环境，之后的项目都会在这个虚拟环境下运行。

![](./images/N12-虚拟环境/Python中文指南-20211128-171029-971252.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-106253.png)

需要将如标示路径，加入到 环境变量 PATH 中。

![](./images/N12-虚拟环境/Python中文指南-20211128-171030-091255.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171028-936251.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171028-906253.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171028-967262.png)

有的python第三方包旧版本会有安全漏洞，使用 pipenv check 可以检查安全漏洞。

![](./images/N12-虚拟环境/Python中文指南-20211128-171028-951254.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-376251.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-391254.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-406251.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-420249.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-436256.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-451250.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-481256.png)

执行 `pipx ensurepath` 可以确保 `~/.local/bin` 这个重要的目录，已经放入到 `$PATH` 的变量中。

![](./images/N12-虚拟环境/Python中文指南-20211128-171030-466252.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-691252.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-706253.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171029-761254.png)
...
![](./images/N12-虚拟环境/Python中文指南-20211128-171030-721257.png)
