...
![](./images/N13-绝佳工具/Python中文指南-20211128-171029-581254-1703351162000-3356.png)
...
![](./images/N13-绝佳工具/Python中文指南-20211128-171029-596258.png)

有好几处不符合 pep8规范，我们试着 commit 一下：

![](./images/N13-绝佳工具/Python中文指南-20211128-171029-611252.png)



可以看到两个 hook 都没有通过，另外 `black`帮我们把代码格式化了。

![](./images/N13-绝佳工具/Python中文指南-20211128-171029-626254.png)

同时`flake8`提示我们`x`变量定义了但是没有使用，把这一行删掉，然后重新add 并 commit：

![](./images/N13-绝佳工具/Python中文指南-20211128-171029-642258.png)
