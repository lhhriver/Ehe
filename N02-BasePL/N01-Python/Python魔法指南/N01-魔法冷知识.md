...
![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-669807-1703351616781-3852.png)
...
![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-700809-1703351616781-3853.png)

有没有一种方式？可以省去每次都加 `python` 呢？

当然有，你可以文件头里加上`#!/usr/bin/python` ，那么当这个文件有可执行权限 时，只直接写这个脚本文件，就像下面这样。

![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-687809-1703351616781-3854.png)

明白了这个后，再来看看 `!/usr/bin/env python` 这个 又是什么意思 ？

当我执行 `env python` 时，自动进入了 python console 的模式。

![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-715812-1703351616781-3855.png)
...
![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-729806-1703351616781-3856.png)
...
就会自动打开一个网页。
![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-579808-1703351616781-3857.png)
...
![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-819816.png)
...
![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-790810.png)



如果你在自己的电脑上尝试一下，结果可能是这样的

![](./images/N01-魔法冷知识/Python魔法指南-20211130-180412-804823.png)
...
![](./images/N01-魔法冷知识/Python魔法指南-20211130-180413-166969.png)
