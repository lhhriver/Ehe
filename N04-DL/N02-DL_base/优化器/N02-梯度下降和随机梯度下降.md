...
show_trace(res)
```
![](./images/N02-梯度下降和随机梯度下降/优化器-20201215-224441-784179.svg)
...
```
![](./images/N02-梯度下降和随机梯度下降/优化器-20201215-224441-788983.svg)
...
```
![](./images/N02-梯度下降和随机梯度下降/优化器-20201215-224441-801984.svg)
...
```
![](./images/N02-梯度下降和随机梯度下降/优化器-20201215-224441-816740.svg)
...
```
![](./images/N02-梯度下降和随机梯度下降/优化器-20201215-224441-848224.svg)
