...
def main_inception3():
    # print("官方版".center(80, "*"))
    # inception3 = torchvision.models.inception_v3(pretrained=False)
    # pretrained_dict = inception3.state_dict()
    ...
    vis_graph.render('model/inception3_model', view=False, cleanup=True)
