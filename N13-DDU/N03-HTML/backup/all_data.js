var all_data = {
	...
	"dv": {
		...
		"value": {
			...
			"Layout": "版图",
			"LPS": "低功耗仿真",
			"LSI": "Large Scale Integration，大规模集成电路，逻辑门1011k个或晶体管1,00110k个。",
			...
			"MSI": "Medium Scale Integration，中型集成电路，逻辑门11100个或晶体管1011k个。",
			...
			"ULSI": "Ultra Large Scale Integration，极大规模集成电路，逻辑门10,0011M个或晶体管100,00110M个。",
			"USB": "通用串行总线",
			...
			"VHDL-VHSIC(Very High Speed IC) Hardware Description Language": "一种硬件描述语言，和verilog类似",
	...
	"words": {
		...
		"value": {
			...
			"email": "n.(electronic mail)电子信函，电子邮件",
			...
			"explosion": "n.爆炸,爆发",
			"explosive": "a.爆炸(性)的,爆发(性)的 n.爆炸物",
	...
	"kouyu": {
		...
		"value": {
			...
			"Your answer is satisfying. I feel satisfied.": "你的答案是令人满意的我感到很满意",
			...
			"A clear conscience laughs at false accusation.": "只要问心无愧，无端的指责可以一 笑置之",
			"I have a headache, and she has a stomachache.": "我头疼，她胃疼",
			"He glared at Bill, ready to teach him a lesson.": "他臺视着比尔，准备教训他一顿",
			...
			"Computers are becoming a part of our everyday life.": "电子计算机正渐渐成为我们",
			...
			"I'm sorry, these 2 books are 3 days overdue.": "小姐，对不起，这两本书已綺过期3天了",
			...
			"Although we can't see these atoms, they really do exist.": "虽然我们看不见訽子，但它们的确存在",
			...
			"I have to transfer to No. ll bus, but where is the bus stop?": "我需要换乘 11 路公共汽车，但是汽车站在哪儿 ?",
			...
			"The maximum weight allowance is 60 kilos per traveler, excluding hand luggage.": "每个旅客托运的行李最大重量限额是 60 公斤，手提行李除外",
